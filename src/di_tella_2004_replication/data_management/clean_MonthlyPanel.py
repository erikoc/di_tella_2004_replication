...
def _generate_variables_based_on_list_and_loop(
    ...
    """
    Generates a new variable (new_generated_variable) in a pandas DataFrame (df) based on conditions
    on a list of variables (list_a) and a range of values (list_b), replacing the values of the new variable
    with different values on a loop.
...
def _complex_variable_generator(
    ...
    """
    Replaces the values of a variable in a dataframe based on a condition on another variable. Generates a new variable
    based on two existing variables, and generates two new variables based on a list of names, and replaces their
    values based on a condition on an existing variable.
...
def _generate_variable_based_on_three_or_conditions(
    ...
    """
    Generate a new variable in the given pandas DataFrame based on three column conditions.
